...
warn "brew 装的办公媒体工具链：ffmpeg / poppler / python@3.13 / LibreOffice / Noto CJK 字体（可选清理：brew uninstall ffmpeg poppler python@3.13 && brew uninstall --cask libreoffice font-noto-sans-cjk-sc）"
