...
Luckagent supports three engines: **Claude Code**, **Kimi**, and **Codex**. The scaffolded project should be usable by any engine. Key differences you must account for:
...
```bash
curl -s -X POST "http://localhost:${LUCKAGENT_API_PORT:-9100}/api/bots" \
